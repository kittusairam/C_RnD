...
#define BLACK -1
		...
		void Reversi_TestInitGameOverZeroCoins()
		{
			...
			Assert::AreEqual(checkReversiGameOver(game), 0, L"Game Not Completed", 1, 2);
			Assert::AreEqual(1, game->state, L"Board Initialization1", 1, 2);
			Assert::AreEqual(1, game->winner, L"Board Initialization2", 1, 2);
			game = createNewGame(rows, cols, "praveen", "abhijith");
			char table2[4][5] =
			{
				"bbbb",
				"    ",
		...
		void Reversi_TestInitGameDraw()
		{
			...
			initializeReversiGame(game, (char *)table1, rows, cols, WHITE);
			Assert::AreEqual(1, game->state, L"Board Initialization1", 1, 2);
			Assert::AreEqual(0, game->winner, L"Board Initialization2", 1, 2);
		...
		void Reversi_TestMoveInvalid()
		{
			...
			Assert::AreEqual(0, game->NumberofMoves, L"Board Initialization1", 1, 2);
			Assert::AreEqual(WHITE, game->turn, L"Board Initialization2", 1, 2);
			Assert::AreEqual(2, game->whiteCount, L"Board Initialization3", 1, 2);
			Assert::AreEqual(2, game->blackCount, L"Board Initialization4", 1, 2);

			playMove(game, createMove(5, 3));
			playMove(game, createMove(6, 3)); //invalid

			Assert::AreEqual(3, game->blackCount, L"Board Initialization5", 1, 2);
			Assert::AreEqual(3, game->whiteCount, L"Board Initialization6", 1, 2);
			Assert::AreEqual(2, game->NumberofMoves, L"Board Initialization7", 1, 2);

			playMove(game, createMove(6, 3)); //invalid
			Assert::AreEqual(2, game->NumberofMoves, L"Board Initialization8", 1, 2);
		};
		...
		void Reversi_TestFullGame1()
		{
			...
			for (int i = 0; i < 12; i++){
				...
				Assert::AreEqual(whiteMoveCount[i], game->whiteCount, L"Board Initialization1", 1, 2);
				Assert::AreEqual(blackMoveCount[i], game->blackCount, L"Board Initialization2", 1, 2);
			}
			Assert::AreEqual(checkReversiGameOver(game), 0, L"Game Not Completed", 1, 2);
			Assert::AreEqual(12, game->NumberofMoves, L"Board Initialization3", 1, 2);
			Assert::AreEqual(1, game->state, L"Board Initialization4", 1, 2);
			Assert::AreEqual(BLACK, game->winner, L"Board Initialization5", 1, 2);
		};
		...
		void Reversi_TestFullGame4()
		{
			...
			for (int i = 0; i < 11; i++){
				Assert::AreEqual(turn[i], game->turn, L"Board Initialization1", 1, 2);
				Assert::AreEqual(checkReversiGameOver(game), 1, L"Game Not Completed", 1, 2);
				playMove(game, createMove(MoveX[i], MoveY[i]));
				Assert::AreEqual(whiteMoveCount[i], game->whiteCount, L"Board Initialization2", 1, 2);
				Assert::AreEqual(blackMoveCount[i], game->blackCount, L"Board Initialization3", 1, 2);
			}
			Assert::AreEqual(checkReversiGameOver(game), 0, L"Game Not Completed4", 1, 2);
			Assert::AreEqual(11, game->NumberofMoves, L"Board Initialization4", 1, 2);
			Assert::AreEqual(1, game->state, L"Board Initialization5", 1, 2);
		...
		void Reversi_TestHelpers2()
		{
			...
			initializeReversiGame(game, (char *)table1, rows, cols, WHITE);
			game->turn = WHITE;
			Assert::AreEqual(0, hasMove(game), L"hasMove( False1 )", 1, 2);
			game->turn = BLACK;
			Assert::AreEqual(1, hasMove(game), L"hasMove( False2 )", 1, 2);
			playMove(game, createMove(2, 2));
			Assert::AreEqual(1, game->NumberofMoves, L"hasMove( False3 )", 1, 2);
		...
		void Reversi_TestHelpers3()
		{
			...
			Assert::AreEqual(0, game->NumberofMoves, L"MoveCount( ++ )1", 1, 2);
			for (int i = 1; i <= 10; i++){
				incrementMoves(game);
				Assert::AreEqual(i, game->NumberofMoves, L"MoveCount( ++ )2", 1, 2);
			}
		...
		void Reversi_TestHelpers4()
		{
			...
			Assert::AreEqual(0, game->state, L"Turn1", 1, 2);
			Assert::AreEqual(0, game->state, L"Turn2", 1, 2);
			endGame(game);
			Assert::AreEqual(0, game->state, L"Turn3", 1, 2);
