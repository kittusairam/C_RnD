...
int main(){
	...
	//Count Ones 
	int count = countOnes(13);
	printf("There are %d ones in the multiple of 13\n", count);
	...
	//nth fibonacci
	int nfib = nthFibonacci(19);
	printf("%d is nth fibonacci\n", nfib);

	//decimal to octal
	int num = octalToHexadecimal(1);
	printf("%d is the octal value of 12\n", num);
	unsigned int re = swapBits(47, 1, 5, 3);
	printf("%u\n", re);
	getchar();
	return 0;
}